          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Manu-2000T/oracle-guided-learning" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Oracle Guided Learning Validation</h3>
              <p>
                Validated Oracle Guided Learning flows to ensure smooth onboarding and module navigation.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Manu-2000T/AutoWebQA" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                </div>
            </header>
            <div className="body">
              <h3>AutoWebQA: Cross-Browser UI Test Framework</h3>
              <p>Designed and implemented WebGuardian – a scalable end-to-end UI automation framework using Playwright and TypeScript. Automated core user flows across Chromium, Firefox, and WebKit using POM architecture.</p>
            </div>
            <footer> <ul className="tech-list"> <li>JavaScript</li> <li>React.js</li> <li>HTML/CSS</li> </ul> </footer>
          </div>
        </ScrollAnimation>
